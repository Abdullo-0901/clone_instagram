...
//        <div className="border-b flex items-center border-gray-400">
//        <Avatar
//     src="/static/images/avatar/1.jpg"
//     sx={{ width: 106, height: 106 }}
// />
// <div className="flex  gap-2 ">
//   <h3 className='font-bold text-lg'>abdulloh_0901</h3>
//   <Button label={"Пописаться"} clasName={"rounded-xl p-[3px_8px]"}/>
// </div>
//        </div>
//       </div>
//     </div>
            ...
            <div className="mt-[30px] ml-[100px]">
              ...
              <div className="flex gap-[38px] mt-[20px]">
                ...
                <div className="flex gap-[7px]">
                  ...
                  ></h1>
                  <div>{profileById?.data.postCount}</div>
